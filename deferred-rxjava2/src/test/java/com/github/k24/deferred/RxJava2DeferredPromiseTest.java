...
/**
 * Created by k24 on 2017/02/27.
 */
public class RxJava2DeferredPromiseTest {
    ...
    private RxJava2DeferredPromise<Integer> emptyPromise;
    private RxJava2DeferredPromise<Integer> intPromise;
    private RxJava2DeferredPromise<Integer> errorPromise;

    @Before
    public void setUp() throws Exception {
        emptyPromise = new RxJava2DeferredPromise<>();
        emptyPromise.resolve(null);
        intPromise = new RxJava2DeferredPromise<>();
        intPromise.resolve(TEST_ITEM);
        errorPromise = new RxJava2DeferredPromise<>();
    ...
    public void isPending() throws Exception {
        assertThat(emptyPromise.isPending()).isFalse();
        assertThat(intPromise.isPending()).isFalse();
        assertThat(errorPromise.isPending()).isFalse();
        RxJava2DeferredPromise<Integer> deferredPromise = new RxJava2DeferredPromise<>();
        assertThat(deferredPromise.isPending()).isTrue();
    }
