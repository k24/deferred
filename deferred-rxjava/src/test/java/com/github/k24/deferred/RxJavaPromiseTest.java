 ...
 */
public class RxJavaPromiseTest {
    ...
    private RxJavaPromise<Integer> emptyPromise;
    private RxJavaPromise<Integer> intPromise;
    private RxJavaPromise<Integer> errorPromise;

    @Before
    public void setUp() throws Exception {
        emptyPromise = RxJavaPromise.empty();
        intPromise = RxJavaPromise.just(TEST_ITEM);
        errorPromise = RxJavaPromise.error(TEST_ERROR);
    }
